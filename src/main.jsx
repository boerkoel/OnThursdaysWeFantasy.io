    ...
    <main className="site">
      ...
      <section id="awards" className="section">
        ...
        <div className="award-grid">
          ...
          <article className="award-card"><span>🛒</span><small>GET A LIFE</small><strong>{awards.awwards?.getALife?.team || "—"}</strong><p>{awards.awards?.getALife?.moves ? awards.awards.getALife.moves + " roster moves" : "No roster activity yet"}</p></article>
